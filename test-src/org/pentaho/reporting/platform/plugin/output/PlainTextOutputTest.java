...
public class PlainTextOutputTest extends TestCase {
  ...
  public void testPaginate() throws Exception {
    assertEquals( 0, plainTextOutput.paginate( null, 0 ) );
  }

  public void testSupportsPagination() throws Exception {
    assertEquals( false, plainTextOutput.supportsPagination() );
  }

  public void testGetReportLock() throws Exception {
    assertEquals( plainTextOutput, plainTextOutput.getReportLock() );
  }
}
