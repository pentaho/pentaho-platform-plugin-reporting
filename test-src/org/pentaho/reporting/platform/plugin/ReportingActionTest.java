...
import org.pentaho.platform.engine.security.userrole.ws.MockUserDetailsRoleListService;
...
public class ReportingActionTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    microPlatform = new MicroPlatform("resource/"); //$NON-NLS-1$
  ...
  public void testPdf() throws Exception
  {
    ...
    SecurityHelper.runAsUser("joe", new Callable<Object>() { //$NON-NLS-1$
