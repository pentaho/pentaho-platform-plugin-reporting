...
public class ParameterIT {
  private static final String SOLUTION_PATH = "resource/solution";
  ...
  public static void setUp() throws Exception {
    ...
    final File tmp = new File( "./resource/solution/system/tmp" );
    tmp.mkdirs();
...
*/
  ...
  public void testParameterQuery() throws Exception {
    ...
    MasterReport report = (MasterReport) mgr
      .createDirectly( new File( "resource/solution/test/reporting/prd3882.prpt" ), MasterReport.class ).getResource();
