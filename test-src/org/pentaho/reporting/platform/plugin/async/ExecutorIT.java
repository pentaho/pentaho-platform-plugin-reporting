...
public class ExecutorIT extends SpringIT {
  ...
  public void testRecalc() throws IOException, ExecutionException, InterruptedException {
    try {
      ...
      simpleReportingComponent.setReportDefinitionPath( "resource/solution/test/reporting/100rows.prpt" );
      simpleReportingComponent.setInputs( Collections.singletonMap( "query-limit", 500 ) );

      executor
        .addTask(
          new PentahoAsyncReportExecution( "resource/solution/test/reporting/100rows.prpt", simpleReportingComponent,
      ...
      assertNotEquals( uuid, recalculate );
