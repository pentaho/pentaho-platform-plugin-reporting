...
public class ReportContentGenerator extends SimpleContentGenerator {
  ...
  private Element createParameterElement(final boolean subscribe, final Map<String, Object> inputs, final Document document,
    ...
    if (subscribe) {
      parameterElement.setAttribute(
          "parameter-group-label", org.pentaho.reporting.platform.plugin.messages.Messages.getInstance().getString("ReportPlugin.ReportParameters")); //$NON-NLS-1$ //$NON-NLS-2$
    }
  ...
  private void addSubscriptionParameter(final String reportDefinitionPath, final Element parameters, final Map<String, Object> inputs) {
    ...
    reportNameParameter.setAttribute(
        "parameter-group-label", org.pentaho.reporting.platform.plugin.messages.Messages.getInstance().getString("ReportPlugin.ReportSchedulingOptions")); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    final String email = PentahoSystem.getSystemSetting("smtp-email/email_config.xml", "mail.smtp.host", ""); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    subscriptionIdElement.setAttribute(
        "parameter-group-label", org.pentaho.reporting.platform.plugin.messages.Messages.getInstance().getString("ReportPlugin.ScheduleReport")); //$NON-NLS-1$ //$NON-NLS-2$
