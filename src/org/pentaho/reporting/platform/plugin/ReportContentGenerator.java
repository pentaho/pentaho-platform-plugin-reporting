  ...
  public class StagingHandler {
    ...
    public void complete() throws IOException {
      switch (mode) {
        ...
        case TMPFILE : {
          // Close the tmp file and use as input
    ...
    try {
      ...
      if (!validates ) {
        ...
        if (  reportComponent.execute()) {
          ...
          if (log.isDebugEnabled()) {
            log.debug(Messages.getString("ReportPlugin.logEndGenerateContent", String.valueOf(reportStagingHandler.getWrittenByteCount())));//$NON-NLS-1$
          }
