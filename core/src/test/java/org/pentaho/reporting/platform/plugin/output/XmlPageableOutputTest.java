...
public class XmlPageableOutputTest {
  XmlPageableOutput xmlPageableOutput;
  private IAsyncReportListener listener;

  @Before public void setUp() {
    xmlPageableOutput = new XmlPageableOutput();
  ...
  @Test public void testSupportsPagination() throws Exception {
    Assert.assertEquals( true, xmlPageableOutput.supportsPagination() );
  }

  @Test public void testGetReportLock() throws Exception {
    Assert.assertEquals( xmlPageableOutput, xmlPageableOutput.getReportLock() );
  }

  @Test
  public void testGenerateListener() throws Exception {
    ClassicEngineBoot.getInstance().start();
    xmlPageableOutput.generate( new MasterReport(), 1, new ByteArrayOutputStream(), 1 );
