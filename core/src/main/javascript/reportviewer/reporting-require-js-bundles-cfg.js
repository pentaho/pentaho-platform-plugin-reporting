  ...
  require.config({
    bundles: {
      "reportviewer/reportviewer-main-module": [
        ...
        "jquery",
        "common-ui/util/require-css/normalize",
        "common-ui/util/require-css/css",
        "common-ui/util/require-css/css!cdf/lib/theme/cupertino/jquery-ui-1.10.4.custom",
        ...
        "common-ui/util/require-css/css!cdf/lib/chosen/chosen",
        "common-ui/util/require-css/css!cdf/lib/hynds/jquery.multiselect",
        "common-ui/util/require-css/css!cdf/lib/select2/select2",
        ...
        "common-ui/util/require-css/css!cdf/components/MultiButtonComponent",
        ...
        "common-ui/util/require-css/css!common-ui/prompting/components/DojoDateTextBoxComponent",
        ...
        "common-ui/util/require-css/css!cdf/lib/impromptu/jquery-impromptu",
        "cdf/lib/shims",
        ...
        "common-ui/util/require-css/css!cdf/dashboard/Dashboard.legacy",
        "cdf/dashboard/Dashboard.legacy",
        "cdf/dashboard/Dashboard.lifecycle",
        "cdf/dashboard/Dashboard.notifications.ext",
        "common-ui/util/require-css/css!cdf/dashboard/Popups",
        "cdf/dashboard/Popups",
        "common-ui/util/require-css/css!cdf/dashboard/Dashboard.notifications",
        ...
        "common-ui/util/require-css/css!cdf/Dashboard",
        "cdf/Dashboard",
        "cdf/Dashboard.Clean",
