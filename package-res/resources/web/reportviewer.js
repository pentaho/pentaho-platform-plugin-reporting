var ReportViewer = {
  ...
  parseParameterDefinition: function(xmlString) {
    ...
    this.parameterParser.normalizeParameterValue = ReportViewer.normalizeParameterValue;
  ...
  createTextFormatter: function(paramDefn, parameter, pattern) {
    ...
    if (!parameter.list && dataFormat) {
      var formatter = jsTextFormatter.createFormatter(parameter.type, dataFormat);
  ...
  convertTimeStampToTimeZone: function(value, timezone) {
    ...
    var localFormat = jsTextFormatter.createFormatter('date', "yyyy-MM-dd'T'HH:mm:ss.SSS");
