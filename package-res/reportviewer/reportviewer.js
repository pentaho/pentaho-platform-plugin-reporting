    ...
    var v = logged({
      ...
      view: logged({
        ...
        _calcReportContentVisibility: function(promptPanel) {
          ...
          var visible = this._hasReportContent();

          if(visible && this._updateReportRenderMode !== 'SUBSCRIBE') {
            // Valid data (although report content should be blank here)
            visible = !promptPanel.paramDefn.promptNeeded &&
      ...
      scheduleReport: function(promptPanel) {
         this.submitReport(promptPanel, {renderMode: 'SUBSCRIBE'});
      },
      ...
      _buildReportContentOptions: function(promptPanel) {
        ...
        options['renderMode'] = this._updateReportRenderMode || 'REPORT';
